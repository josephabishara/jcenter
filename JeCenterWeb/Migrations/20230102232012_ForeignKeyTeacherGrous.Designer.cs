...
namespace JeCenterWeb.Migrations
{
    ...
    [Migration("20230102232012_ForeignKeyTeacherGrous")]
    partial class ForeignKeyTeacherGrous
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JeCenterWeb.Models.CGroupSchedule", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("GroupscheduleId"), 1L, 1);
            ...
            modelBuilder.Entity("JeCenterWeb.Models.FinancialAccounts", b =>
                {
                    b.Property<int>("AccountID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JeCenterWeb.Models.FinancialJournalEntry", b =>
                {
                    ...
                    b.Property<decimal>("JournalEntryValue")
                    ...
                    b.ToTable("FinancialJournalEntry");
                });
            ...
            modelBuilder.Entity("JeCenterWeb.Models.FinancialJournalEntryLine", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("JournalEntryDetilsID"), 1L, 1);
            ...
            modelBuilder.Entity("JeCenterWeb.Models.FinancialJournals", b =>
                {
                    b.Property<int>("JournalId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JeCenterWeb.Models.FinancialJournalType", b =>
                {
                    b.Property<int>("JournalTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("JournalTypeId"), 1L, 1);
                    ...
                    b.ToTable("FinancialJournalType");
                });
            ...
            modelBuilder.Entity("JeCenterWeb.Models.TeacherGroups", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TeacherGroupId"), 1L, 1);
            ...
            modelBuilder.Entity("JeCenterWeb.Models.FinancialJournalEntry", b =>
                {
                    b.HasOne("JeCenterWeb.Models.FinancialJournals", "FinancialJournals")
                        .WithMany("FinancialJournalEntry")
                    ...
                    b.Navigation("FinancialJournals");
            ...
            modelBuilder.Entity("JeCenterWeb.Models.FinancialJournalEntryLine", b =>
                {
                    b.HasOne("JeCenterWeb.Models.FinancialAccounts", "FinancialAccounts")
                        .WithMany("FinancialJournalEntryLine")
                        .HasForeignKey("AccountID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JeCenterWeb.Models.FinancialJournalEntry", "FinancialJournalEntry")
                        .WithMany("FinancialJournalEntryLine")
                    ...
                    b.Navigation("FinancialJournalEntry");
                });

            modelBuilder.Entity("JeCenterWeb.Models.FinancialJournals", b =>
                {
                    b.HasOne("JeCenterWeb.Models.FinancialJournalType", "FinancialJournalType")
                        .WithMany("FinancialJournals")
                        .HasForeignKey("JournalTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("FinancialJournalType");
                });
